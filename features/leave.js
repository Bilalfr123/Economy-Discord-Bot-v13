...
var text3 = `You were our ${count}th members!`
var text4 = `Good-Bye from ${member.guild.name}`
if(text1.length >= 14) {
...
const text = `Bye <@${member.user.id}>, It was great time having you in ${guild.name}.Please make sure to back.Have a great time!`
